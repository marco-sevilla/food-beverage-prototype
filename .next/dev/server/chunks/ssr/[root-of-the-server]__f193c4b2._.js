...
const MenuItem = ({ name, entryPoint, onEdit, onDelete, isLast = false })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Claude$2d$Projects$2f$canary$2d$foodandbeverage$2d$prototype$2f$food__and__beverage__prototype$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
const MenuManagementPage = ({ onEditMenu })=>{
    const menuItems = [
        {
            name: 'Breakfast menu',
...
const EditMenuPage = ({ onBack, menuName = "Lunch menu" })=>{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f193c4b2._.js.map