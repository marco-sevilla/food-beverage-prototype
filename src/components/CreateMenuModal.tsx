      ...
      <div className="flex-none rotate-[16deg]">
        <div className="overflow-clip relative size-[64px]">
          <svg width="96" height="80" viewBox="0 0 96 80" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
            <g clipPath="url(#clip0_bouncing)">
              <path d="M50.2877 23.233L59.1186 39.1643L52.3783 62.6704L16.4912 52.3799L26.7817 16.4928L50.2877 23.233ZM51.7578 18.1063L28.2517 11.3661C25.432 10.5575 22.4635 12.203 21.6549 15.0227L11.3645 50.9098C10.5559 53.7295 12.2014 56.6981 15.0211 57.5066L50.9082 67.7971C53.7279 68.6056 56.6965 66.9601 57.505 64.1404L64.2453 40.6344C64.6349 39.2758 64.4714 37.8141 63.7693 36.5864L54.9385 20.6551C54.2693 19.4091 53.1164 18.4959 51.7578 18.1063ZM24.5581 43.5965L50.1917 50.9468L48.7216 56.0736L23.088 48.7232L24.5581 43.5965ZM27.4982 33.343L53.1318 40.6934L51.6618 45.8201L26.0281 38.4698L27.4982 33.343ZM30.4383 23.0896L48.3819 28.2348L46.9118 33.3615L28.9683 28.2163L30.4383 23.0896Z" fill="url(#paint0_linear_bouncing)"/>
            </g>
            ...
            <motion.path 
              ...
              fill="url(#paint1_linear_bouncing)"
              animate={{
                y: [0, -8, 0],
                scale: [1, 1.1, 1]
              }}
            ...
            <motion.path 
              ...
              fill="url(#paint2_linear_bouncing)"
              animate={{
                y: [0, -8, 0],
                scale: [1, 1.1, 1]
              }}
            ...
            <motion.path 
              ...
              fill="url(#paint3_linear_bouncing)"
              animate={{
                y: [0, -8, 0],
                scale: [1, 1.1, 1]
              }}
            ...
            />
            <defs>
              <linearGradient id="paint0_linear_bouncing" x1="9.89441" y1="56.0366" x2="56.7562" y2="68.8558" gradientUnits="userSpaceOnUse">
                <stop stopColor="#1937ED"/>
                <stop offset="0.495192" stopColor="#D429AF"/>
                <stop offset="1" stopColor="#DD3131"/>
              </linearGradient>
              <linearGradient id="paint1_linear_bouncing" x1="66.6932" y1="18.3489" x2="30.8031" y2="15.088" gradientUnits="userSpaceOnUse">
                <stop offset="0.0865385" stopColor="#DB3044"/>
                <stop offset="0.485577" stopColor="#3F35E0"/>
              </linearGradient>
              <linearGradient id="paint2_linear_bouncing" x1="84.7836" y1="31.8439" x2="37.5264" y2="4.55996" gradientUnits="userSpaceOnUse">
                <stop offset="0.0865385" stopColor="#DB3044"/>
                <stop offset="0.423077" stopColor="#3F35E0"/>
              </linearGradient>
              <linearGradient id="paint3_linear_bouncing" x1="61.25" y1="34.2506" x2="73.4747" y2="34.1011" gradientUnits="userSpaceOnUse">
                <stop stopColor="#1937ED"/>
                <stop offset="0.495192" stopColor="#D429AF"/>
                <stop offset="1" stopColor="#DD3131"/>
              </linearGradient>
              <clipPath id="clip0_bouncing">
...
export const CreateMenuModal: React.FC<CreateMenuModalProps> = ({
  ...
  const handleParseAndCreate = async () => {
    ...
    try {
      ...
      console.error('❌ Error parsing menu for upload:', uploadId, error);
      setUploadError(`Error parsing menu: ${error instanceof Error ? error.message : 'Please try again.'}`);
      setUploadState('uploaded');
    }
  };
  ...
  const handleApiKeySave = (apiKey: string) => {
    setIsApiKeyModalOpen(false);
    setHasApiKey(true);
    // If we have a file waiting, process it now
    if (uploadedFile) {
