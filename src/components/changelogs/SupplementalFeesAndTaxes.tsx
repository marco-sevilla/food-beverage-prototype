    ...
    <div className="space-y-8">
      ...
      <section>
        ...
        <p className="text-gray-600 leading-relaxed">
          The Settings page in F&B Ordering has been enhanced with dynamic supplemental fees and taxes management. 
          This update allows hotel operators to configure flexible pricing structures with validation, 
          real-time editing, and persistent storage.
        </p>
      </section>
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-2 text-gray-600">
              ...
              <li><strong>Drag Handle:</strong> Six-dot icon appears when 2+ fees exist (drag functionality prepared for future)</li>
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-2 text-gray-600">
              ...
              <li><strong>Drag Handle:</strong> Appears when 2+ taxes exist for reordering preparation</li>
            </ul>
          </div>
      ...
      <section>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
          <ul className="space-y-2 text-blue-900">
            ...
            <li>• Drag-and-drop infrastructure ready (handlers visible, functionality pending)</li>
